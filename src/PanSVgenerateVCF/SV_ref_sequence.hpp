...
#ifndef PANSVGENERATEVCF_SV_REF_SEQUENCE_HPP_
#define PANSVGENERATEVCF_SV_REF_SEQUENCE_HPP_
#include <stdlib.h>
#include <vector>
...
public:
	...
	void output_VCF_header(FILE* vcf_header){
		...
		fprintf(vcf_header, "##FORMAT=<ID=DP,Number=1,Type=String,Description=\"Depth around breakpoints(bp1, bp2) and assembly reads number around breakpoints(bp1, bp2)\">\n");
...
#endif /* PANSVGENERATEVCF_SV_REF_SEQUENCE_HPP_ */
