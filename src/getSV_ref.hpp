...
#ifndef GETSV_REF_HPP_
#define GETSV_REF_HPP_
...
struct VCF_HANDLER{
	...
	void add_options(options_list &l){
	    l.add_title_string("\n");
	    l.add_title_string("  Usage:     ");  l.add_title_string(PACKAGE_NAME);  l.add_title_string("  sv_ref  [Options] [ref.fa] [input.vcf]>\n");
