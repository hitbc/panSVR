...
typedef struct {
	...
	int mqe, mqe_t;        // mqe: max score when reaching the end of query; mqe_t: the extension coordinate of target when reaching the end of query
	int mte, mte_q;        // max score when reaching the end of target;  mqe_t: the extension coordinate of query when reaching the end of target
